...
#Mean Accuracy: -0.005699620742744883
#Accuracy: 59.66 %.
...
# Calculate and display accuracy
print('Mean Absolute Error1:', round(np.mean(errors1), 2))
#Mean Absolute Error1: 0.02
...
parameters = {'batch_size':[25,32], 'nb_epoch':[15,20],'optimizer':['adam','rmsprop']}
